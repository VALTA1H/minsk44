...
label pre_history:
    ...
    n_narr "В то время как они обстреливали сами себя, чтобы выдать это за жертву..."
    ...
    n_narr "Сегодня, 28 июня, надеюсь, последнего года войны. Мы сегодня форсируем реку Березину, чтобы не дать этим фрицам отступить и занять новые позиции"
...
label start:
    ...
    narr "Так точно!"
    ivan "Также у нас новобранец Захаров. Расскажи ему, что да как"
    narr "Есть!"
...
label kolya_meet:
    ...
    narr "Мы сегодня форсируем реку Березину. Ты будешь прикрывать меня сзади. Задача ясна?"
