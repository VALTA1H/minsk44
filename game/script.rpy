...
label pre_history:
    ...
    n_narr "Уже который год идет кровопролитная война которая решает нашы судьбы"
    n_narr "Я помню то, как в своей родной деревне проводил чудесно время со своей женой"
    n_narr "Те теплые майские дни, Те самые моменты когда мы были счастливы"
    n_narr "Но потом началсь война..."
    n_narr "Немцы обманув западный мир и попытавшись выставив себя миратворацами начали преступную войну"
    n_narr "Сказав что их обстреляли на границе поляки осенью 39 года."
    n_narr "В то время когда они обстреливали сами себя чтобы выдать за жертву..."
    n_narr "Душа улиц на которых раньше жили люди заменила безумно громкая тишина"
    n_narr "Столько людей, семей, чиьх то домов и сел просто пропали как будто их никогда и не было"
    n_narr "Сейчас мы даже не так весь наш великий народ ценой своих жизней и нашего будущего оставляет свет для будущих поколений чтобы они никогда больше не познали ужасы и тяготы войн"
    n_narr "Сегодня 28 июня надеюсь последнего года войны и мы сегодня фарсируем реку Березину чтобы не дать этим фрицам отступить и занять новые позиции"
...
label start:
    ...
    narr "Так точно!"
    ivan "Также у нас новобранец Захаров, расскажи ему что да так"
    narr "Есть!"
...
label find_solider:
    ...
    menu:
        ...
        "Проверить у пулеметного гнезда.":
            ...
            narr "Здесь я не увидел не кого нового посмотрю в другом месте"
            jump find_solider

        "Заглянуть в землянку для отдыха.":

            narr "Вижу какогото хилово мальчишку в форме которая ему на пару размеров больше похоже это он"
            jump kolya_meet
...
label kolya_meet:
    ...
    narr "Мы сегодня фарсируем реку береизну ты будешь прекрывать меня с сзади задача ясна?"
    narr "Чуть что обращайся здесь твоя любая ошибка может стоить жизни"
    ...
    n_narr "Спокойно, Коля. Первый раз всегда страшно. Держись рядом."
