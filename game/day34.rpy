...
label day34_start:
    ...
    narr "1 июля. Третий день прорыва. Мы ушли от Бобруйска — вглубь белорусских лесов. И даже тут слышен этот гул работающей артиллерии.."
    ...
    menu:
        ...
        "Будем приидерживаться изначального плана.":
...
label trail_pursuit:
    ...
    if not avoided_ambush:
        ...
        n_narr "После ожесточенного боя мы все же смогли отбиться и выйти из засады живыми."
...
label road_march:
    ...
    n_narr "Она даёт кусок хлеба и иконку. Мы ее поблагодарили и пошли дальше."
...
label bridge_assault:
    ...
    n_narr "У меня емть считанные мнгоневния на принятие решения."
...
label bridge_victory:
    ...
    if kolya_saved:
        ...
        narr "Хоть твое спасение и стоило мне ранением, но твоя жизнь важнее."
