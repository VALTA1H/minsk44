...
label day34_start:
    ...
    narr "1 июля. Третий день прорыва. Мы ушли от Бобруйска — вглубь белорусских лесов."
    ...
    ivan "След свежий. Колёса, копыта… и кровь."
...
label night_camp:
    ...
    if (saved_soldier or spared_civilians) and protected_masha:
        ...
        masha "Я из Хатыни… Там, где сожгли деревню."
        ...
        masha "Я из Хатыни. Из той деревни, что стёрли с земли…"
...
label bridge_victory:
    ...
    n_narr "Коля молча чистит винтовку. Его взгляд — зеркало моего выбора."
