...
define gui.about = _p("""
«Минск 1944: Безымянный» — историческая визуальная новелла о памяти, долге и будущем Беларуси, посвящённая 80-летию её освобождения от немецко-фашистских захватчиков.\n
Игра погружает вас в пять напряжённых дней наступления Красной армии от Березины до Минска, где каждый ваш выбор определяет не только ход боя, но и моральный облик героя. Сможете ли вы сохранить человечность в аду войны? 

Разработчики:\n
— Арсений Дерновский: композитор, программист, визуализатор.\n
— Алтай Коджакулак: сценарист, режиссёр, визуализатор.

Отдельное спасибо Nicol Armarfi и blue123 и 4LeafStudios.

Лицензирование:
Исходный код игры распространяется под лицензией GPLv3.\n
Музыка и графика защищены лицензией Creative Commons.
""")
...
define config.save_directory = "minsk44-1761043646"
