...
label day5_start:
    ...
    narr "3 июля 1944 года. Пятый день прорыва."
    n_narr "Утро. Мы стоим на окраине Минска. Город — в дыму, но колокола звонят. Люди выходят на улицы."
...
label pows_camp_ruins:
    ...
    n_narr "Я поднимаю куклу. Кладу в карман — рядом с иконкой и обещанием."
...
label freedom_square_approach:
    ...
    ivan "Группа 'А' — слева по развалинам. Группа 'Б' — за мной. ГГ — прикрываешь."
...
label minsk_liberated:
    ...
    politruk "Сегодня — великий день! Республика Беларусь свободна!"
    ...
    if chose_duty:
        n_narr "Я выжил. Но смогу ли я простить себя?"
    elif chose_comrades:
