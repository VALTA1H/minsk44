...
label day2_start:
    ...
    n_narr "Из подвала развалин выбегает мужчина лет сорока. Его лицо покрыто сажей, руки в ожогах и ссадинах глаза полны отчаяния."
    ...
    ivan "Где он? Покажи."
    soldier "Там, в подвале соседнего дома. Но… там ещё и фриц... Раненый... Они вместе, как в ловушке."
...
label day2_basement:
    ...
    #Добавь музыку звервств или трагичную
