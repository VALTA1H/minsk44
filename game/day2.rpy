...
label day2_sleep:
    ...
    n_narr "Сон был коротким и тревожным. Неудивительно, после вчерашних событий."
...
label day2_start:
    ...
    soldier "Мой брат… он ранен! Вчера, когда начался штурм, его ранило, и теперь он не может идти!"
    ivan "Где он? Проведи нас к нему."
    soldier "Там, в подвале соседнего дома. Но… там ещё и фриц... Раненый... Они вместе, как в ловушке."

    n_narr "Старшина Иван переглядывается со мной. Ситуация сложная. Раненый враг — это опасность и ответственность за соотечественника."
    ...
    menu choice_wounded_enemy:
        "Идти спасать обоих":
            ...
            hanz "Те тёти, которых мы оставили в живых... Они все будут должны служить и зиговать нашему фюреру!"
            #ABSOLUTE CINEMA
...
label day2_basement_peaceful:
    ...
    n_narr "Подвал наполнен сыростью и страхом. На полу, прижавшись к углу, сидит старуха с ребёнком на руках."
